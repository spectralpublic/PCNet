...
class RandomDataset(Dataset):
    def __init__(self, transform=None, dataloader=default_loader):
        ...
        with open('/home/user3/Desktop/zy/API-Net-master/data/NWPU_10/NWPU_10_test.txt', 'r') as fid:
...
class BatchDataset(Dataset):
    def __init__(self, transform=None, dataloader=default_loader):
        ...
        with open('/home/user3/Desktop/zy/API-Net-master/data/NWPU_10/NWPU_10_train.txt', 'r') as fid:
            self.imglist = fid.readlines()
